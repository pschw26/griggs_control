...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphWidget.setGeometry(QtCore.QRect(10, 460, 821, 201))
...
"")
        ...
        self.label_30.setGeometry(QtCore.QRect(590, 310, 91, 21))
        self.label_30.setObjectName("label_30")
        self.lcd_stress_s3 = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcd_stress_s3.setGeometry(QtCore.QRect(590, 380, 64, 23))
        ...
        self.label_31.setGeometry(QtCore.QRect(680, 310, 131, 21))
        self.label_31.setObjectName("label_31")
        self.lcd_dstress = QtWidgets.QLCDNumber(self.centralwidget)
        self.lcd_dstress.setGeometry(QtCore.QRect(700, 340, 64, 21))
        self.lcd_dstress.setObjectName("lcd_dstress")
        self.pushB_get_adc = QtWidgets.QPushButton(self.centralwidget)
        self.pushB_get_adc.setGeometry(QtCore.QRect(420, 260, 111, 31))
        self.pushB_get_adc.setObjectName("pushB_get_adc")
        self.tabWidget_2 = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget_2.setGeometry(QtCore.QRect(410, 0, 421, 221))
        ...
        self.frame_2.setGeometry(QtCore.QRect(110, 100, 31, 31))
        self.frame_2.setAutoFillBackground(False)
        self.frame_2.setStyleSheet("QFrame{border: 2px solid black\n"
"}")
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.label_valve_s3 = QtWidgets.QLabel(self.frame_2)
        self.label_valve_s3.setGeometry(QtCore.QRect(0, 0, 31, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_valve_s3.setFont(font)
        self.label_valve_s3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_valve_s3.setObjectName("label_valve_s3")
        self.line_15 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_15.setGeometry(QtCore.QRect(65, 64, 21, 76))
        self.line_15.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_15.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_15.setObjectName("line_15")
        self.line_5 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_5.setGeometry(QtCore.QRect(150, 0, 21, 31))
        font = QtGui.QFont()
        ...
        self.line_18 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_18.setGeometry(QtCore.QRect(110, 130, 31, 25))
        self.line_18.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_18.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_18.setObjectName("line_18")
        self.line_7 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_7.setGeometry(QtCore.QRect(140, 55, 21, 21))
        self.line_7.setAutoFillBackground(False)
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.frame_3 = QtWidgets.QFrame(self.valve_sys_info)
        self.frame_3.setGeometry(QtCore.QRect(60, 140, 31, 31))
...
"}")
        ...
        self.label_34.setGeometry(QtCore.QRect(0, 0, 31, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line_21 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_21.setGeometry(QtCore.QRect(200, 170, 20, 18))
        self.line_21.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_21.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_21.setObjectName("line_21")
        self.line_4 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_4.setGeometry(QtCore.QRect(10, 0, 101, 31))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.line_19 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_19.setGeometry(QtCore.QRect(60, 170, 31, 21))
        self.line_19.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_19.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_19.setObjectName("line_19")
        self.line_17 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_17.setGeometry(QtCore.QRect(90, 145, 34, 21))
        self.line_17.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_17.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_17.setObjectName("line_17")
        self.frame = QtWidgets.QFrame(self.valve_sys_info)
        self.frame.setGeometry(QtCore.QRect(110, 50, 31, 31))
...
"}")
        ...
        self.label_33.setGeometry(QtCore.QRect(0, 0, 31, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line_13 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_13.setGeometry(QtCore.QRect(40, 145, 21, 21))
        self.line_13.setAutoFillBackground(False)
        self.line_13.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_13.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_13.setObjectName("line_13")
        self.valve_1 = QtWidgets.QFrame(self.valve_sys_info)
        self.valve_1.setGeometry(QtCore.QRect(110, 0, 31, 31))
        self.valve_1.setAutoFillBackground(False)
        self.valve_1.setStyleSheet("QFrame{border: 2px solid black\n"
"}")
        self.valve_1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.valve_1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.valve_1.setObjectName("valve_1")
        self.label_32 = QtWidgets.QLabel(self.valve_1)
        self.label_32.setGeometry(QtCore.QRect(0, 0, 31, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.frame_4 = QtWidgets.QFrame(self.valve_sys_info)
        self.frame_4.setGeometry(QtCore.QRect(180, 140, 61, 31))
        self.frame_4.setStyleSheet("QFrame{border: 2px solid black\n"
"}")
        ...
        self.label.setStyleSheet("QFrame{border: 2px solid black}\n"
"")
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.line_8 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_8.setGeometry(QtCore.QRect(150, 50, 21, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.line_9 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_9.setGeometry(QtCore.QRect(140, 105, 21, 21))
        self.line_9.setAutoFillBackground(False)
        self.line_9.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_9.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_9.setObjectName("line_9")
        self.line_14 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_14.setGeometry(QtCore.QRect(30, 140, 21, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.line_11 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_11.setGeometry(QtCore.QRect(110, 30, 31, 20))
        self.line_11.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_11.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_11.setObjectName("line_11")
        self.line_12 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_12.setGeometry(QtCore.QRect(110, 80, 31, 21))
        self.line_12.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_12.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_12.setObjectName("line_12")
        self.line_16 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_16.setGeometry(QtCore.QRect(76, 50, 34, 31))
        self.line_16.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_16.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_16.setObjectName("line_16")
        self.line_20 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_20.setGeometry(QtCore.QRect(74, 180, 136, 16))
        self.line_20.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_20.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_20.setObjectName("line_20")
        self.line_6 = QtWidgets.QFrame(self.valve_sys_info)
        self.line_6.setGeometry(QtCore.QRect(140, 5, 21, 21))
        self.line_6.setAutoFillBackground(False)
        self.line_6.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.label_36 = QtWidgets.QLabel(self.valve_sys_info)
        self.label_36.setGeometry(QtCore.QRect(274, 22, 121, 31))
        self.label_36.setAlignment(QtCore.Qt.AlignCenter)
        self.label_36.setObjectName("label_36")
        self.label_37 = QtWidgets.QLabel(self.valve_sys_info)
        self.label_37.setGeometry(QtCore.QRect(263, 56, 121, 31))
        self.label_37.setAlignment(QtCore.Qt.AlignCenter)
        self.label_37.setObjectName("label_37")
        self.label_38 = QtWidgets.QLabel(self.valve_sys_info)
        self.label_38.setGeometry(QtCore.QRect(275, 92, 131, 31))
        self.label_38.setAlignment(QtCore.Qt.AlignCenter)
        self.label_38.setObjectName("label_38")
        self.label_39 = QtWidgets.QLabel(self.valve_sys_info)
        self.label_39.setGeometry(QtCore.QRect(260, 130, 121, 31))
        self.label_39.setAlignment(QtCore.Qt.AlignCenter)
        self.label_39.setObjectName("label_39")
        self.frame_5 = QtWidgets.QFrame(self.valve_sys_info)
        self.frame_5.setGeometry(QtCore.QRect(160, 100, 51, 31))
        self.frame_5.setStyleSheet("QFrame{border: 2px solid black}")
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.label_s3_active = QtWidgets.QLabel(self.frame_5)
        self.label_s3_active.setGeometry(QtCore.QRect(0, 0, 51, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_s3_active.setFont(font)
        self.label_s3_active.setStyleSheet("QFrame{border: 2px solid black}\n"
"")
        self.label_s3_active.setAlignment(QtCore.Qt.AlignCenter)
        self.label_s3_active.setObjectName("label_s3_active")
        self.label_35 = QtWidgets.QLabel(self.valve_sys_info)
        self.label_35.setGeometry(QtCore.QRect(10, 20, 46, 13))
        self.label_35.setObjectName("label_35")
        self.tabWidget_2.addTab(self.valve_sys_info, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_36.setText(_translate("MainWindow", "1: close at experimental \n"
" conditions"))
        self.label_37.setText(_translate("MainWindow", "2: Pump -> opened \n"
" Quench -> closed"))
        self.label_38.setText(_translate("MainWindow", "3: Pump -> closed (green) \n"
" Quench -> opened (red)"))
        self.label_39.setText(_translate("MainWindow", "4: Pump -> closed \n"
" Quench -> opened"))
        self.label_s3_active.setText(_translate("MainWindow", "Motor"))
        self.label_35.setText(_translate("MainWindow", "Machine"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.valve_sys_info), _translate("MainWindow", "Valve System Info"))
